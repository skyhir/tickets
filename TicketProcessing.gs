...
// NOTE: processTicketPayments() lives in paymentprocessing.gs. A stale single-tab
// copy used to live here; because Apps Script loads every .gs into one global scope,
// the later-loaded copy silently overwrote the multi-tab one. Do not redefine it here.
